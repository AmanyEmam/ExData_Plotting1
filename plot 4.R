...
par(mfrow = c(2,2))         
with(subpower, {
  plot(Time, as.numeric(as.character(subpower$Global_active_power)), type ="l", ylab="Global Active Power",xlab="")   
  plot(Time, Voltage, type = "l", xlab = "datetime", ylab = "Volatge")
